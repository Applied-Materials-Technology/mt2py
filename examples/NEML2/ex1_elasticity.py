...
# Load in the model.
file = Path('examples/data/ex1_elastic.e')
...
nmodel = neml2.reload_model('examples/neml2_models/elastic_model.i', "implicit_rate")
...
fig.tight_layout()
fig.savefig('examples/NEML2/ex1_elasticity.png')